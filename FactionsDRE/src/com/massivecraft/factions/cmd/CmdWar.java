	...
	public void perform() {
		if(Conf.fwarEnabled){
			...
			if(argFaction!=null){
				...
				me.sendMessage(ChatColor.GOLD+"Dieses Kriegssystem basiert auf dem Fordern von Items und Geld. Dem Verteidiger ist es somit möglich den Krieg durch das bezahlen der Forderungen zu beenden.");
				me.sendMessage(ChatColor.GOLD+"Beendet der Verteidiger den Krieg durch das bezahlen der Forderungen so ist er für "+Conf.fwarDaysAfterWarProtection+" Tage gegen erneuten Krieg mit den Angreifern geschützt.");
				...
				me.sendMessage(ChatColor.YELLOW+"/f war <Fraktionsname> confirm"+ChatColor.GOLD+" Bestätigt die gestellten Forderungen uns Startet einen Countdown von "+Conf.fwarHoursUntilWarStartsAfterDemand+" Stunden bis der Krieg ausbricht");
