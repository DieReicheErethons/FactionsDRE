...
public class FWars extends EntityCollection<FWar> {
	...
	private FWars() {
		super(FWar.class, new CopyOnWriteArrayList<FWar>(), new ConcurrentHashMap<String, FWar>(), new File(P.p.getDataFolder(), "wars.json"), P.p.gson);
	}

	@Override
	public Type getMapType() {
		return new TypeToken<Map<String, FWar>>() {
		}.getType();
	}
