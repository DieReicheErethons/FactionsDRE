...
public class BuildingType {
	...
	public static boolean isIgnoredBlock(byte block) {
		if (block == 0 || block == 6 || block == 8 || block == 9 || block == 10 || block == 11 || block == 30 || block == 31 || block == 32 || block == 37 || block == 38 || block == 39 || block == 40
				|| block == 50 || block == 51 || block == 59 || block == 78 || block == 106 || block == 111 || block == 115)
			return true;
