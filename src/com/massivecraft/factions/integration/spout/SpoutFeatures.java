...
public class SpoutFeatures {
	...
	private transient static SpoutInputListener inputListener;
	private transient static SpoutScreenListener screenListener;
	...
	public static void setAvailable(boolean enable, String pluginName) {
		...
		if (!listenersHooked) {
			...
			inputListener = new SpoutInputListener();
			screenListener = new SpoutScreenListener();
			Bukkit.getServer().getPluginManager().registerEvents(mainListener, P.p);
			Bukkit.getServer().getPluginManager().registerEvents(inputListener, P.p);
			Bukkit.getServer().getPluginManager().registerEvents(screenListener, P.p);
		}
	}
